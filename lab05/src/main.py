...
from relaksacja_wielosiatkowa import relaksacja_wielosiatkowa
from utils import create_images_folder, warunki_dirichleta
from utils import N_Y, N_X, k

if __name__ == "__main__":
    print("W celu szybszego sprawdzenia działania programu zalecam uruchomienie komendą make run\n"
    ...
    while k >= 1:
        it, s = relaksacja_wielosiatkowa(k, V)
        iteracje.append(it)
        S.append(s)
        k //= 2
